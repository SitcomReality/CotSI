...
Verifies that every relative import in dev/analysis/ resolves to a real file,
...
Usage:  python3 dev/check_analysis_imports.py
...
ANALYSIS = os.path.join(ROOT, 'dev', 'analysis')
