/**
 * projectControls.js — Project-level actions: download, load JSON, create.
 *
 * Wires the chrome header buttons. Downloads the current descriptor as JSON,
 * loads a normalized/validated descriptor from a file, and swaps the session
 * descriptor for a fresh template (objectTemplates.js). `ctx` supplies the
 * post-change hooks (renderAll / onEdit / onLoaded); `els` carries the
 * button + error refs.
 */
