...
| `worldObjects/descriptors/data/` | Descriptor data: one file per object (`<id>.js`, generated by the geometry editor — see `data/index.js`); `base.js`/`mob.js` are table-driven |
| `worldObjects/fruitTree/index.js` | Fruit-tree module barrel (buildFruitTreeMeshes, buildChunkFruitTreeMeshes) |
