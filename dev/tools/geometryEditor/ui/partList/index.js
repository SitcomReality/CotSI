/**
 * partList/index.js — Parts list for the geometry editor sidebar.
 *
 ...
 * only while expanded (rendered recursively by rows.js). Owns the list session
 * state (the whole-list expand flag); the per-group collapse state lives in
 * rows.js.
 */
...
import { appendRows } from './rows.js';
