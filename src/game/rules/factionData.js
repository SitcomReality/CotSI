...
export const FACTIONS = [
  ...
  { id:2, name:'Verdant', short:'VER', glyphId:'g-verdant',  textGlyph:'[VER]', base:'#3a5a3a', color:'#5a8a4a', glow:'#88d888', uiColor:'#6ad06a', uiGlow:'#a8f0a8', trait:"Gaia's Wail", desc:'Cheap forest moves, mobs pacified, Blessed Font heal++', terrainCosts:{ forest:4, denseForest:6 } },
  ...
  { id:6, name:'Hollow',  short:'HOL', glyphId:'g-hollow',   textGlyph:'[HOL]', base:'#3a3a44', color:'#5a5a7a', glow:'#a0a8c0', uiColor:'#8080b0', uiGlow:'#b8b8e0', trait:'Vaunted Nothing', desc:'+⌈week/3⌉ per missing HP', terrainCosts:{ denseForest:10 } },
];
