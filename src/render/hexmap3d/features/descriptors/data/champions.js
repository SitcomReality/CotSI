...
const ACCENTS = {
  CRU: [{ id: 'spikeTop', shape: 'cone', params: { bottomR: 0.03, height: 0.06, radialSegs: 4, heightSegs: 1 }, transform: { y: 0.58 }, color: 'factionAccent' }],
  REV: [{ id: 'halo', shape: 'torus', params: { radius: 0.11, tube: 0.015, radialSegs: 4, tubularSegs: 8 }, transform: { y: 0.45, localAxis: { x: 1, y: 0, z: 0 }, localAngle: Math.PI / 2 }, color: 'factionAccent' }],
  VER: [{ id: 'leaf', shape: 'cone', params: { bottomR: 0.03, height: 0.05, radialSegs: 4, heightSegs: 1 }, transform: { y: 0.55, tiltAxis: { x: 1, z: 0 }, tilt: 0.5 }, color: 'factionAccent' }],
  ARC: [{ id: 'orb', shape: 'sphere', params: { radius: 0.035, wSegs: 6, hSegs: 4 }, transform: { y: 0.58 }, color: 'factionAccent' }],
  ...
  MSK: [{ id: 'gem', shape: 'dodecahedron', params: { radius: 0.035, detail: 0 }, transform: { y: 0.58 }, color: 'factionAccent' }],
  HOL: [{ id: 'pendant', shape: 'cone', params: { bottomR: 0.03, height: 0.05, radialSegs: 4, heightSegs: 1 }, transform: { y: 0.38, localAxis: { x: 1, y: 0, z: 0 }, localAngle: Math.PI }, color: 'factionAccent' }],
};
