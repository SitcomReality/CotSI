  ...
  parts: [
    {
      ...
      shape: 'cylinder',
      params: { bottomR: 0.035, topR: 0.05, height: 0.32, segments: 6 },
      transform: {
        localPos: { x: -0.16, y: 0, z: -0.05 },
        liftRange: { min: 0.02, max: 0.22, seed: 4 },
      },
      stretch: { y: { min: 0.8, max: 1.5, seed: 6 }, x: false, z: false },
      color: 0x9aa8b0,
    ...
    },
    {
      ...
      shape: 'cone',
      params: { bottomR: 0.11, height: 0.2, radialSegs: 6, heightSegs: 1 },
      transform: {
